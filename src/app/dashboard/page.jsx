...
function toText(val) {
  ...
  if (typeof val === "object") return val.msg || JSON.stringify(val);
  return String(val);
}
      ...
      if (!res.ok) {
        ...
        if (data && data.detail) {
          if (Array.isArray(data.detail)) {
            setError(data.detail.map((d) => d.msg || JSON.stringify(d)).join(", "));
    ...
    <div className="carbon-form-container">
      ...
      {carbonResult !== null && (
        <div className="result" aria-live="polite">
          ...
          <p>This activity added {toText(carbonResult)} kg CO₂ to your footprint.</p>
